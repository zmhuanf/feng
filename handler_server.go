...
func handlePushBack(_ *server, req *message) error {
	if !req.Success {
...
func handleRequestBack(ctx IServerContext, s *server, req *message, isSys bool) error {
...
func handlePushOrRequest(ctx IServerContext, s *server, req *message, u *user, isSys bool) error {
